...
public class MikornPutCassandraQL extends AbstractCassandraProcessor {
    private final static Logger logger4j = LogManager.getLogger(MikornPutCassandraQL.class);
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        logger4j.info(String.format("%s, Trigger time: %s", this.getClass().getName(), timeStart));
        ...
        try {
            ...
            try {
                ...
                logger4j.info(String.format("%s, process tranfer success, time %s, elapsed time: %s",
                        this.getClass().getName(), timeEnd, (timeEnd - timeStart)));
