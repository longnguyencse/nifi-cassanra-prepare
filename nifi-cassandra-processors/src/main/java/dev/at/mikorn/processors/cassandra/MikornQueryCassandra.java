...
public class MikornQueryCassandra extends AbstractCassandraProcessor {
    private final static Logger logger4j = LogManager.getLogger(MikornQueryCassandra.class);
