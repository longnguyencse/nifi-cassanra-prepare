...
//
///**
// * Unit tests for the MikornPutCassandraQL processor
// */
...
//        testRunner.setProperty(AbstractCassandraProcessor.CONTACT_POINTS, "192.168.1.158:9042");
//        testRunner.assertValid();
//        testRunner.setProperty(AbstractCassandraProcessor.PASSWORD, "test");
//        testRunner.assertNotValid();
//        testRunner.setProperty(AbstractCassandraProcessor.USERNAME, "ifp");
...
//        testRunner.setProperty(MikornPutCassandraQL.STATEMENT_TIMEOUT, "${timeout}");
//
//        testRunner.assertValid();
//    }
//
...
//        testRunner.assertAllFlowFilesTransferred(MikornPutCassandraQL.REL_SUCCESS, 1);
...
//
//        testRunner.run(1, true, true);
//        testRunner.assertAllFlowFilesTransferred(MikornPutCassandraQL.REL_FAILURE, 1);
//        testRunner.clearTransferState();
//    }
//
//    @Test
...
//        testRunner.enqueue("UPDATE users SET cities = [ 'New York', 'Los Angeles' ] WHERE user_id = 'coast2coast';");
//        testRunner.run(1, true, true);
//        testRunner.assertAllFlowFilesTransferred(MikornPutCassandraQL.REL_RETRY, 1);
//    }
//
//    @Test
...
//     */
//    private static class MockPutCassandraQL extends MikornPutCassandraQL {
//
